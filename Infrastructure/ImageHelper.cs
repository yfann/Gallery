...
namespace Infrastructure
{
    ...
    {
        public static void GetImageName(string path, out string name, out string extName)
        {
        ...
        protected static Bitmap MakeThumbnail(Bitmap source, int width, int height, ThumbnailType mode)
        {
            Bitmap originalImage = source;
        ...
        protected static void MakeThumbnail(string originalImagePath, string thumbnailPath, int width, int height, string mode)
        {
